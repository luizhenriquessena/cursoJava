...
public class FuncoesString {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * ### Recortar ### 
		 * substring(inicio) - Informando o in�cio
		 * substring(inicio, fim) - Informando o in�cio e final
		 * 
		 * ### Substituir ###
		 * Replace(char, char) - Caractere
		 * Replace (string, string) - String
		 * 
		 * ### Buscar ### Buscar posi��o em uma string
		 * IndexOf 
		 * LastIndexOf
		 * 
		 ...
		 * */
		 ...
		 System.out.println("Primeira posi��o: "+ vect[0]);
		 System.out.println("Segunda posi��o: "+ vect[1]);
		 System.out.println("Terceira posi��o: "+ vect[2]);
