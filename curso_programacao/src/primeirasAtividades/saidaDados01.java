...
public class saidaDados01 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%.4f%n",x); // Impress�o ap�s Locale
		System.out.println("RESULTADO = " + x + "METROS"); // (+) utilizado para concatenar
		System.out.printf("RESULTADO = %.2f METROS ou %d %n",x, y); // (%f, %.2f, etc) substitui pelo valor da vari�vel seguindo a ordem.
